    ...
    >
      ...
      <div className="flex pt-4 justify-center gap-6 pb-4 mt-auto">
        <a
          ...
          className={
            `text-par text-sm flex justify-center items-center github` +
            ` ${
              isGitHovered
                ? 'text-or fill-or transition-all duration-300 ease-in'
                : ''
            } `
          }
        >
          <svg
            ...
            className="bi bi-github mr-2 w-4 hover:transition-all duration-300 ease-in"
            viewBox="0 0 16 16"
          >
        ...
        <a
          ...
          onMouseLeave={handleOffLinkHover}
          className={
            `text-par text-sm flex justify-center items-center` +
            ` ${
              isSiteHovered
                ? 'text-or fill-or transition-all duration-300 ease-in'
                : ''
        ...
        >
          <svg
            ...
            className="bi bi-globe mr-2 w-4 hover:transition-all duration-300 ease-in"
            viewBox="0 0 16 16"
          >
